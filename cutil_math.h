...
/*
 *  int4 addition function
 */
inline __host__ __device__ int4 make_int4(int s)
{
    return make_int4(s, s, s, s);
}
inline __host__ __device__ int4 make_int4(const float4& a, const float bias)
{
    return make_int4(int(a.x+bias), int(a.y+bias), int(a.z+bias), int(a.w+bias));
}
