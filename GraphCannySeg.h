...
//            printf("%s: min: %f, max: %f\n",name.c_str(),minVal, maxVal);
    ...
    void computePCA(const std::vector<cv::Point3i>& pts,
                    ...
                    double& eccentricity,bool viz_=false);
    ...
    void inline computeValueHist(const cv::Mat& image, bool isHSV, const cv::Mat& mask, cv::Mat_<float>& Val_HistNorm, cv::Mat& histImage,int clusterArea,int Hbins=256, bool viz_=false )
    {
    ...
    void inline computeSatHist(const cv::Mat& image, bool isHSV, const cv::Mat& mask, cv::Mat_<float>& Sat_HistNorm, cv::Mat& histImage,int Hbins=256, bool viz_=false )
    {
    ...
    void inline computeHueHist(const cv::Mat& image, bool isHSV ,const cv::Mat& mask, cv::Mat_<float>& Hue_HistNorm, cv::Mat& histImage,int Hbins=180, bool viz_=false )
    {
